  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              <span
                ...
                style={isActive
                  ? { color: "#00d4ff", filter: "drop-shadow(0 0 6px rgba(0,212,255,0.6))" }
                  : {}}
              >
                <Icon />
              </span>
      ...
      <div className="p-3 mt-2">
        <div className="mx-0 mb-3" style={{ height: 1, background: "rgba(0,212,255,0.08)" }} />
        {loading ? (
          <div className="px-3 py-2">
            <div className="skeleton h-8 w-full rounded-xl" />
          </div>
        ) : user ? (
          <div className="flex items-center gap-2.5 px-3 py-2 rounded-xl group" style={{ background: "rgba(0,212,255,0.04)" }}>
            <div
