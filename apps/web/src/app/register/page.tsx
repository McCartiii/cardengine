  ...
  if (success) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-bg px-4">
        <div className="w-full max-w-md animate-scale-in rounded-2xl border border-border bg-surface p-8 text-center shadow-[var(--shadow-elevated)]">
          ...
          <h2 className="mt-4 text-2xl font-bold text-text-primary">Check your email</h2>
          ...
          <Link
            href="/login"
            className="mt-6 inline-block rounded-xl bg-accent px-6 py-2.5 text-sm font-semibold text-white transition-all hover:bg-accent-hover hover:shadow-md"
          >
            Back to login
          </Link>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-surface p-8 shadow-[var(--shadow-elevated)]">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-text-secondary">
              Join Card Engine to manage your collection
            </p>
          </div>
